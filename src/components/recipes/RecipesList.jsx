      ...
      <table className="w-full min-w-[800px]">
        <thead>
          <tr className="border-b border-gray-100 dark:border-gray-800">
            ...
            <th className="text-left py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">Data de Criação</th>
        ...
        <tbody>
          {recipes.map((recipe) => (
            ...
            >
              ...
              <td className="py-3 px-4">
                <p className="text-sm text-gray-900 dark:text-white">{recipe.unit}</p>
              </td>
              <td className="py-3 px-4">
